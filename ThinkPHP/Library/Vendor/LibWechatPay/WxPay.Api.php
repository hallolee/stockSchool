...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
        ...
        if( $result['result_code'] != 'SUCCESS' )
        {
            ...
            \Think\LOG::write( "response = '$response'" );
        }
	...
	/**
	 * Get necessary parameters for jsapi in web pay
    ...
    {
        if(
            !isset( $UnifiedOrderResult['appid'] ) ||
            !isset( $UnifiedOrderResult['prepay_id'] ) ||
            !$UnifiedOrderResult[ 'prepay_id' ]
        )
        {
            trigger_error( 'Bad param for unified order' );
            return [];
        }
